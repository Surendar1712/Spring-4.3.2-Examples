package com.expression.library.ex.pgms;
...
/**
 * Here we have used spring 4.3.2 jars. But spring expression library has been
 * introduced in spring 3 itself. But logical operator evaluation are getting
 * failed. So, we are using spring 4 jars which is supporting logical operators
 * 
 * @author Surendar
 *
 */
